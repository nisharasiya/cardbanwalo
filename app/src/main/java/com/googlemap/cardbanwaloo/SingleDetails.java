...
public class SingleDetails extends AppCompatActivity {
    ...
    List<SingleCardDetailsBean> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cd = new ConnectionDetector(SingleDetails.this);
        ...
        fromdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(SingleDetails.this);
    ...
    public void loadData() {
        if (cd.isConnectingToInternet()) {
            ...
            Call<List<SingleCardDetailsBean>> call = cr.singlecarddetails("", pref.getString("mst" , ""), fd, td, status);

            call.enqueue(new Callback<List<SingleCardDetailsBean>>() {
                @Override
                public void onResponse(Call<List<SingleCardDetailsBean>> call, Response<List<SingleCardDetailsBean>> response) {
                ...
                @Override
                public void onFailure(Call<List<SingleCardDetailsBean>> call, Throwable t) {
            ...
            Toast.makeText(SingleDetails.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
    ...
    public class Gridadapter extends RecyclerView.Adapter<Gridadapter.MyViewholder> {
        ...
        List<SingleCardDetailsBean> list = new ArrayList<>();

        public Gridadapter(Context context, List<SingleCardDetailsBean> list) {
        ...
        public void onBindViewHolder(@NonNull MyViewholder holder, int position) {
            ...
            SingleCardDetailsBean item = list.get(position);

            holder.name.setText(item.getName());
            holder.fn.setText(item.getFather());
            holder.mn.setText(item.getMother());
            holder.mob.setText(item.getMobile());
            holder.address.setText(item.getAddress());
            holder.adm.setText(item.getAdmno());
            holder.cls.setText(item.getClass_());



        }

        public void setgrid(List<SingleCardDetailsBean> list) {
        ...
        public class MyViewholder extends RecyclerView.ViewHolder {
            ...
            TextView name, fn, mn, cls, mob, address, adm;
            ...
            public MyViewholder(View itemView) {
                ...
                fn = itemView.findViewById(R.id.fathername);
                mn = itemView.findViewById(R.id.mothername);
